...
foreach($datasetToSend as $task):?>
	...
	<div class="form-group" style="width: 30%;padding-top: 5%;margin-left: auto;margin-right: auto">
		...
		<textarea class="form-control" rows="10" id="<?= $task['work']?>comment"><?php echo "float work(float arg1, float arg2) {\n\n}"?></textarea>
...
<div style="margin-top: 50px;margin-left: auto;margin-right: auto;float: right;">
	<a type="button" class="btn btn-primary btn-sm" id="send" href="/mbou4260/lesson/ctest?student=<?= $task['user']?>">Отправить на проверку</a>
</div>
</body>
</html>
